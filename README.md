...
🧠 About the Project
The ripeness of bananas significantly affects their quality, taste, and market value. This project aims to assist consumers and sellers by providing an AI-powered tool to automatically classify bananas based on ripeness using image analysis.
The model was trained on images of ripe and unripe bananas taken under varying conditions, enabling robust classification in real-world scenarios.
